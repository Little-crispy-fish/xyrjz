...
- `USER_STORAGE_QUOTA_MB` 控制每个账号的个人中心私有文件空间，默认 500MB。
...
- 每个登录账号默认分配 500MB 空间。
- 个人空间入口在前端“个人中心”。
- 学生、教师、管理员都可以上传自己的个人文件。
- 普通用户只能查看、下载和删除自己的个人文件，不能看到其他账号的个人文件。
- 服务端会在上传时校验配额，超过 500MB 会拒绝上传。
